...
class Bank_Account:
    ...
    def calculateintrest(self,value):
        self.amount=self.amount+value
...
def main():
    ...
    User1.calculateintrest(10.8)
    print("_________calculateintrest 10.8 is User2_______")
    User2.calculateintrest(10.2)
    print("amount of {} after calculateintrest is {}".format(User1.name,User1.amount))
    print("amount of {} after calculateintrest is {}".format(User2.name,User2.amount))

    print("_____________")
    print("___________end of banking application_____")
    print("______________")
